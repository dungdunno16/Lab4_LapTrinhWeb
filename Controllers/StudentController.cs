...
namespace ThongTinSinhVien.Controllers
{
	...
	public class StudentController : Controller
    {
        ...
        public StudentController()
        {
            ...
            {
                new Student() { Id = 101, Name = "Hải Nam", mark = 10.0, Branch = Branch.IT,
                Gender = Gender.Male, IsRegular=true,
                Address = "A1-2018", Email = "nam@g.com" },

                new Student() { Id = 102, Name = "Minh Tú", mark = 9.0, Branch = Branch.BE,
                Gender = Gender.Female, IsRegular=true,
                Address = "A1-2019", Email = "tu@g.com" },

                new Student() { Id = 103, Name = "Hoàng Phong", mark = 9.5, Branch = Branch.CE,
                Gender = Gender.Male, IsRegular=false,
                Address = "A1-2020", Email = "phong@g.com" },

                new Student() { Id = 104, Name = "Xuân Mai", mark = 9.0, Branch = Branch.EE,
